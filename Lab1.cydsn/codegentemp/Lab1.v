...
module top ;
	...
	wire [0:0] tmpOE__SW_5_net;
	wire [0:0] tmpFB_0__SW_5_net;
	wire [0:0] tmpIO_0__SW_5_net;
	wire [0:0] tmpINTERRUPT_0__SW_5_net;
	electrical [0:0] tmpSIOVREF__SW_5_net;

	cy_psoc3_pins_v1_10
		#(.id("6d39e0fe-2703-4022-894d-01598acda1e0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SW_5
		 (.oe(tmpOE__SW_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_5_net[0:0]}),
		  .io({tmpIO_0__SW_5_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_5_net),
		  .interrupt({tmpINTERRUPT_0__SW_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW_4_net;
	wire [0:0] tmpFB_0__SW_4_net;
	wire [0:0] tmpIO_0__SW_4_net;
	wire [0:0] tmpINTERRUPT_0__SW_4_net;
	electrical [0:0] tmpSIOVREF__SW_4_net;

	cy_psoc3_pins_v1_10
		#(.id("db70751c-9445-42a5-a8c1-86e0e1660764"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
